...
export default function Experiencia() {
  return (
    <section className="w-full py-32 bg-gradient-to-b from-[#F6F1EA] via-[#E8DFD4] to-[#f4eee629] flex justify-center relative overflow-hidden">
      ...
      <div className="relative carta-anim max-w-3xl w-full mx-6 bg-white rounded-md shadow-[0_35px_90px_rgba(0,0,0,0.35)] p-12">
        ...
        {/* linea roja margen */}
        <div className="absolute top-0 bottom-0 left-12 w-[2px] bg-red-300 opacity-60"></div>
